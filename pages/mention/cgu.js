...
const CGU = () => {
  return (
    <>
      <Header />
      <h1 className="title-article">Conditions générales d'utilisation</h1>
        ...
        <div className="container-article">
          <article>
            ...
            <p>
              ...
              l'encadrement juridique de l’utilisation du Dzair History et de
              ses services. Les conditions générales d'utilisation doivent être
            ...
            <p>
              ...
              service. Le site Dzair History se réserve le droit de modifier les
            ...
            <p>
              ...
              et depuis n’importe où au site Dzair History. Les frais supportés
              par l’Utilisateur pour y accéder (connexion internet, matériel
            ...
            <p>
              Le site peut comprendre un espace membre payant réservé aux
              utilisateurs inscrits. Ces utilisateurs pourront y accéder en
              utilisant leurs identifiants de connexion. Les services réservés
              aux membres sont les suivants : Achats ou/et accès a un contenu
              exclusif.
            </p>
            <br />
            ...
            <br />
            <p>
              Tous les documents techniques, produits, textes, logos, etc., sont
              soumis à des droits d'auteur et sont protégés par le Code de la
              propriété intellectuelle. Lorsqu'ils sont remis à nos clients, ils
              demeurent la propriété exclusive de Dzair History, seul titulaire
              des droits de propriété intellectuelle sur ces documents, qui
              doivent lui être rendus à sa demande.
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              courriel à l'adresse suivante : contact@dzairhistory.xyz.
            </p>
            <br />
            <p>
              ...
              sans obligation de justification à la charge de l'Éditeur. Dans
              tous les cas, tout lien devra être retiré sur simple demande de
              l'Éditeur. Toute information accessible via un lien vers d'autres
              sites n'est pas sous le contrôle de l'Éditeur qui décline toute
            ...
            <br />
            <p>
              Données collectées Les données à caractère personnel qui sont
            ...
            <p>
              <ul>
                ...
                <li>
                  ...
                  prestations proposés sur le site web, celui-ci enregistre des
                  données financières relatives au compte bancaire ou à la carte
                  de crédit de l'utilisateur ;
                </li>
                <li>
                  communication : lorsque le site web est utilisé pour
            ...
            <p>
              Utilisation des données personnelles Les données personnelles
              collectées auprès des utilisateurs ont pour objectif la mise à
              disposition des services du site web, leur amélioration et le
            ...
            <p>
              <ul>
                ...
                <li>
                  ...
                  softwares ou logiciels malveillants) et gestion des incidents
                  de sécurité ;
                </li>
            ...
            <p>
              Partage des données personnelles avec des tiers Les données
              personnelles peuvent être partagées avec des sociétés tierces,
            ...
            <p>
              <ul>
                <li>
                  ...
                  avec des sociétés bancaires et financières tierces avec
                ...
                <li>
                  ...
                  contre le site web et se conformer aux procédures
                  administratives et judiciaires ;
                </li>
                <li>
                  si le site web est impliquée dans une opération de fusion,
                  acquisition, cession d'actifs ou procédure de redressement
                  judiciaire, elle pourra être amenée à céder ou partager tout
                  ou partie de ses actifs, y compris les données à caractère
            ...
            <p>
              Sécurité et confidentialité Le site web met en oeuvre des mesures
              organisationnelles, techniques, logicielles et physiques en
              matière de sécurité du numérique pour protéger les données
              ...
              environnement complètement sécurisé et le site web ne peut pas
            ...
            <p>
              Mise en oeuvre des droits des utilisateurs En application de la
              réglementation applicable aux données à caractère personnel, les
              utilisateurs disposent des droits suivants, qu'ils peuvent exercer
              en faisant leur demande à l'adresse suivante
              :contact@dzairhistory.xyz
            </p>
            <br />
            <p>
              ...
              avant la mise en œuvre de ce droit, le site web peut demander une
              preuve de l'identité de l'utilisateur afin d'en vérifier
              l'exactitude. le droit de rectification : si les données à
              caractère personnel détenues par le site web sont inexactes, ils
              peuvent demander la mise à jour des informations. le droit de
              suppression des données : les utilisateurs peuvent demander la
              suppression de leurs données à caractère personnel, conformément
              aux lois applicables en matière de protection des données. le
              droit à la limitation du traitement : les utilisateurs peuvent de
              demander au site web de limiter le traitement des données
              personnelles conformément aux hypothèses prévues par le RGPD. le
              droit de s’opposer au traitement des données : les utilisateurs
              peuvent s’opposer à ce que ses données soient traitées
              conformément aux hypothèses prévues par le RGPD. le droit à la
              portabilité : ils peuvent réclamer que le site web leur remette
              les données personnelles qui lui sont fournies pour les
              transmettre à un nouveau site web.
            </p>
            <br />
            <p>
              Evolution de la présente clause Le site web se réserve le droit
              d'apporter toute modification à la présente clause relative à la
              protection des données à caractère personnel à tout moment. Si une
              modification est apportée à la présente clause de protection des
              ...
              l'utilisateur n'est pas d'accord avec les termes de la nouvelle
              rédaction de la clause de protection des données à caractère
            ...
            <br />
            <p>
              Le site Dzair History peut collecter automatiquement des
