    ...
    <>
      ...
      <section className="container">
        <div className="container-article">
          <article>
            <p>
              Dzair History, soucieuse des droits des individus, notamment au
              regard des traitements automatisés et dans une volonté de
            ...
            <br />
            1.1 Site (ci-après « le site ») :<p>Dzair History</p>
            <br />
            <h4>1.2 Hébergeur (ci-après « l'hébergeur ») :</h4>
            <br />
            <p>
              Dzair History est hébergé par PlanetHoster., dont le siège social
              est situé Laval (grand Montréal), Québec, Canada.
            </p>
            <br />
            ...
            <br />
            <p>
              Vos données sont collectées par Dzair History Une donnée à
            ...
            <p>
              ...
              en matière de protection des données ; le droit à la limitation du
              traitement : les utilisateurs peuvent de demander à la Plateforme
              de limiter le traitement des données personnelles conformément aux
              hypothèses prévues par le RGPD ; le droit de s’opposer au
              traitement des données : les utilisateurs peuvent s’opposer à ce
              que leurs données soient traitées conformément aux hypothèses
              prévues par le RGPD ; le droit à la portabilité : ils peuvent
              réclamer que la Plateforme leur remette les données
              personnellesqu'ils ont fournies pour les transmettre à une
              nouvelle Plateforme.
            </p>
            <p>Ou par email, à l’adresse : contact@dzairhistory.xyz</p>
            <br />
            <p>
            ...
            <br />
            <p>
              Nous vous recommandons de nous contacter dans un premier temps
              avant de déposer une réclamation auprès de la CNIL, car nous
            ...
            <p>
              ...
              vous fournir ses services ou son assistance. Dans la mesure
              ...
              compte ou que nous n'ayons plus besoin pour vous fournir nos
              services.
            </p>
            <br />
            ...
            <p>
              ...
              <ul>
                <li>
                  ...
                  mise en œuvre de ces services, la Plateforme est en relation
            ...
            <br />
            <p>
              Qu’est-ce qu’un « cookie » ? Un « Cookie » ou traceur est un
              ...
              utilisé (source :
              https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi). En
              naviguant sur ce site, des « cookies » émanant de la société
              responsable du site concerné et/ou des sociétés tiers pourront
              être déposés sur votre terminal. Lors de la première navigation
              sur ce site, une bannière explicative sur l’utilisation des «
              cookies » apparaîtra. Dès lors, en poursuivant la navigation, le
              client et/ou prospect sera réputé informé et avoir accepté
              l’utilisation desdits « cookies ». Le consentement donné sera
              valable pour une période de treize (13) mois. L'utilisateur a la
              possibilité de désactiver les cookies à partir des paramètres de
              son navigateur.{" "}
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              Les cookies suivants sont présents sur ce site : Cookies Google :{" "}
              <br />
              <ul>
                <li>
                ...
                <li>
                  ...
                  sites web ou les vidéos YouTube comme support pour ses
                  annonces.
                </li>
                <li>
                ...
                <li>
                  DoubleClick : cookies publicitaires de Google pour diffuser
                  des bannières.
                </li>
              </ul>
            </p>
            <br />
            <p>
              La durée de vie de ces cookies est de treize mois. Pour plus
              d’informations sur l’utilisation, la gestion et la suppression des
              « cookies », pour tout type de navigateur, nous vous invitons à
            ...
            <p>
              ...
              message à l'adresse suivante : contact@dzairhistory.xyz
            </p>
            <br />
          </article>
        </div>
